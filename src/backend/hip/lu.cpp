...
// hipsolverStatus_t CUDENSEAPI cusolverDn<>getrf_bufferSize(
...
//
//
// hipsolverStatus_t CUDENSEAPI cusolverDn<>getrf(
//        hipsolverHandle_t handle,
//        int m, int n,
//        <> *A,
//        int lda,
...
struct getrf_func_def_t {
    using getrf_func_def = hipsolverStatus_t (*)(hipsolverHandle_t, int, int,
                                                T *, int, T *, int *, int *);
};

template<typename T>
struct getrf_buf_func_def_t {
    using getrf_buf_func_def = hipsolverStatus_t (*)(hipsolverHandle_t, int,
                                                    int, T *, int, int *);
};
